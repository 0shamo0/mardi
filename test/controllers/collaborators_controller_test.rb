...
class CollaboratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collaborator" do
    assert_difference('Collaborator.count') do
      post collaborators_url, params: { collaborator: { collaborator_name: @collaborator.collaborator_name } }
    end
  ...
  test "should update collaborator" do
    patch collaborator_url(@collaborator), params: { collaborator: { collaborator_name: @collaborator.collaborator_name } }
